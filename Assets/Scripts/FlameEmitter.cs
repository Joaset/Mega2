    ...
    void Start()
    {
        ...
        grad.SetKeys(
            new GradientColorKey[] {
                new GradientColorKey(new Color32(0xFA,0xCC,0x22,255), 0.0f), // #FACC22
                new GradientColorKey(new Color32(0xF8,0x98,0x00,255), 0.33f),// #F89800
                new GradientColorKey(new Color32(0xF8,0x36,0x00,255), 0.66f),// #F83600
                new GradientColorKey(new Color32(0x9F,0x04,0x04,255), 1.0f)  // #9F0404
            },
