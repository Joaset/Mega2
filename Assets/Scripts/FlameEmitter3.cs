...
public class FlameEmitter3 : MonoBehaviour
{
    void Start()
    {
        ...
        // Inicio: verde brillante (núcleo del fuego)
        new GradientColorKey(new Color32(0xA8, 0xFF, 0x00, 255), 0.0f),

        // Final: verde oscuro (bordes de la llama)
        new GradientColorKey(new Color32(0x00, 0x8F, 0x3D, 255), 1.0f),
            },
            new GradientAlphaKey[] {
        new GradientAlphaKey(1.0f, 0.0f), // opaco al inicio
